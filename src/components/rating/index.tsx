...
import { StarIcon, StarIconProps } from "./star-icon";
...
export function Rating({
  ...
  return (
    <span className="inline-block touch-action-none">
      <span
        className={cn(
          "relative inline-block overflow-hidden whitespace-nowrap align-middle select-none touch-action-none",
          className
        )}
        style={{
        ...
        aria-hidden="true"
      >
        <span className={cn("flex text-muted-foreground")}>
        ...
        <span
          className={cn(
            "absolute top-0 overflow-hidden inline-block whitespace-nowrap left-0"
          )}
          style={{
      ...
      {showTooltip && (
        <span
          className="inline-block py-1 px-4 bg-gray-800 text-white align-middle rounded"
          style={{
